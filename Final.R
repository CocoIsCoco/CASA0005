...
---
title: "Name: Tongxin Xu"
author: 
- |
    | Student number: 22094040
date: "`r format(Sys.time(), '%X, 16 , DEC , 2022')`"
output: html_document
---
# Originality declaration  

I, [**Tongxin Xu**], confirm that the work presented in this assessment is my own. Where information has been derived from other sources, I confirm that this has been indicated in the work.

date: `r format(Sys.time(), '16 , DEC, 2022')`
